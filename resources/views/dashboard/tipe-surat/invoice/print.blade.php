    ...
    <div class="container">
        <table class="table-borderless" style="border: none!important">
            ...
            <tr>
                ...
                <td><span class="cls_007">: {{ ucwords($pelanggan->pelanggan_nama) }}</span></td>
            </tr>
            <tr>
                ...
                <td><span class="cls_007">: {{ ucwords($pelanggan->perusahaan) }}</td>
            </tr>
            <tr>
                ...
                <td><span class="cls_006">: </span><span class="cls_003">{{ ucwords($pelanggan->pelanggan_alamat) }}</span></td>
            </tr>
            <tr>
                ...
                <td><span class="cls_006">:</span><span class="cls_007"> {{ $pelanggan->pelanggan_telepon }}</span></td>
            </tr>
            <tr>
                <th><span class="cls_006">Status</span></th>
                <td><span class="cls_006">:</span><span class="cls_009">Unpaid</span></td>
